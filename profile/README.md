...
Our process is still relatively informal, so don't hesitate to reach out to [contact@brainsatplay.com](mailto:contact@brainsatplay.com) at any time—or join the organization's [Discord server](https://discord.gg/bbDRSaAmpN)

## Keep Us Going
Brains@Play is funded by community contributions through [Open Collective](https://opencollective.com/brainsatplay).
